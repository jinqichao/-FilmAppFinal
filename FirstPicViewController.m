...
@interface FirstPicViewController ()

@end

@implementation FirstPicViewController
...
- (void)viewDidLoad {
    ...
    [self.flowout setItemSize:CGSizeMake(31,31)];
...
{
    return UIEdgeInsetsMake(9, 6, 101, 10);
}
