...
@interface Play4ViewController ()

@end

@implementation Play4ViewController
...
- (void)viewDidLoad {
    ...
    NSURLRequest *request1=[NSURLRequest  requestWithURL:[NSURL URLWithString:playdic[@"videos"][3][@"url"]]];
